...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('4.50'),
            'ingredients': [{'name': 'Harina'}, {'name': 'Leche'}],
        }
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        ingredient_mexican = (Ingredient.objects.
                              create(user=self.user, name='Chiles'))
        payload = {
            'title': 'Chilaquiles',
            'time_minutes': 20,
            'price': Decimal('3.50'),
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        ingredient_eggs = (Ingredient.objects.
                           create(user=self.user, name='Huevos'))
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Sushi')
        tag1 = Tag.objects.create(user=self.user, name='Mexican')
        tag2 = Tag.objects.create(user=self.user, name='Japaness')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user=self.user, title='Sopes')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Chilaquiles')
        r2 = create_recipe(user=self.user, title='Sushi')
        in1 = Ingredient.objects.create(user=self.user, name='Totopos')
...
class ImageUploadTest(TestCase):
    ...
    def test_upload_image(self):
        """Test Uploading an image to a recpie"""
